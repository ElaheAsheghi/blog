...
urlpatterns = [
    ...
    path('password-change/', auth_views.PasswordChangeView.as_view(success_url='done'),\
    ...
    #author profile
    path('posts/detail/<post_id>/author_profile/', views.author_profile, name="author"),
    path('profile/show_comments/<post_id>', views.show_comments, name="show_comments"),
    #ticket
